    ...
    b.fn.fullpage = function(c) {
        function W(a) {
            if (c.autoScrolling) {
                ...
                a = b(".section.active");
                if (!n && !r)
                    if (f = K(f), v = f.y, z = f.x, a.find(".slides").length && Math.abs(A - z) > Math.abs(w - v)) Math.abs(A - z) > b(window).width() / 100 * c.touchSensitivity && (A > z ? a.find(".controlArrow.next:visible").trigger("click") : a.find(".controlArrow.prev:visible").trigger("click"));
                    ...
                    if (w > v)
                        if (0 < a.length)
                            if (B("bottom", a)) b.fn.fullpage.moveSectionDown();
                            else return !0;
                else b.fn.fullpage.moveSectionDown();
                else if (v > w)
                    if (0 < a.length)
                        if (B("top", a)) b.fn.fullpage.moveSectionUp();
                        else return !0;
        ...
        function p(a) {
            if (c.autoScrolling) {
                ...
                f = b(".section.active");
                if (!n)
                    if (f = f.find(".slides").length ?
                        f.find(".slide.active").find(".scrollable") : f.find(".scrollable"), 0 > a)
                        if (0 < f.length)
                            if (B("bottom", f)) b.fn.fullpage.moveSectionDown();
                            else return !0;
                else b.fn.fullpage.moveSectionDown();
                else if (0 < f.length)
                    if (B("top", f)) b.fn.fullpage.moveSectionUp();
                    else return !0;
                else b.fn.fullpage.moveSectionUp();
                return !1
            }
        ...
        function k(a, f, d) {
            ...
            if ("undefined" !== typeof g) {
                ...
                }, c.scrollingSpeed)) : (b.isFunction(c.onLeave) && c.onLeave.call(this, m, l), b(a).animate(e, c.scrollingSpeed, c.easing,
                    function() {
                        k();
                        b.isFunction(c.afterLoad) && c.afterLoad.call(this, s, E + 1);
                        setTimeout(function() {
        ...
        function y(a, f) {
            ...
            if (c.onSlideLeave) {
                var q = l.find(".slide.active").index(),
                    t;
                t = q > g ? "left" : "right";
                n || b.isFunction(c.onSlideLeave) && c.onSlideLeave.call(this,
                    k, h + 1, q, t)
            }
            ...
            c.css3 ? (d = "translate3d(-" + d.left + "px, 0px, 0px)", a.find(".slidesContainer").addClass("easing").css({
                ...
                n || b.isFunction(c.afterSlideLoad) && c.afterSlideLoad.call(this,
                    k, h + 1, m, g);
                r = !1
        ...
        function P(a, f) {
            c.navigation && (b("#fullPage-nav").find(".active").removeClass("active"),
                a ? b("#fullPage-nav").find('a[href="#' + a + '"]').addClass("active") : b("#fullPage-nav").find("li").eq(f).find("a").addClass("active"))
        }
        ...
        function M(a, c) {
            b("#superContainer").toggleClass("easing",
                c);
        ...
        b.fn.fullpage.setMouseWheelScrolling = function(a) {
            a ? document.addEventListener ? (document.addEventListener("mousewheel", p, !1), document.addEventListener("DOMMouseScroll", p, !1)) : document.attachEvent("onmousewheel", p) : document.addEventListener ? (document.removeEventListener("mousewheel", p, !1),
                document.removeEventListener("DOMMouseScroll", p, !1)) : document.detachEvent("onmousewheel", p)
        };
        ...
        b(".section").each(function(a) {
            ...
            if (c.navigation) {
                ...
                u.find("ul").append('<li data-tooltip="' +
                    a + '"><a href="#' + e + '"><span></span></a></li>')
            }
            if (0 < d) {
                var e = 100 * d,
                    g = 100 / d;
                ...
                "#fff" != c.controlArrowColor && (b(this).find(".controlArrow.next").css("border-color", "transparent transparent transparent " + c.controlArrowColor), b(this).find(".controlArrow.prev").css("border-color",
            ...
            if (a.length) {
                ...
                !c.animateAnchor && f.length && (x(f.position().top), b.isFunction(c.afterLoad) && c.afterLoad.call(this,
                    a, f.index(".section") + 1), f.addClass("active").siblings().removeClass("active"))
            }
